...
/* USER CODE BEGIN EV */
extern SemaphoreHandle_t xjamDetectedSemaphore;
extern SemaphoreHandle_t xwindowLockSemaphore;
extern SemaphoreHandle_t xupperLimitReachedSemaphore;
extern SemaphoreHandle_t xlowerLimitReachedSemaphore;
/* USER CODE END EV */
